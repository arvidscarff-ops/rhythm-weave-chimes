    ...
    return (
      <main className="grid min-h-screen place-items-center bg-background px-6 text-foreground">
        <section className="max-w-md border border-white/10 bg-white/[0.03] p-8 text-center">
          ...
          <h1 className="mt-4 text-lg">Unable to verify Studio access</h1>
          <p className="mt-2 text-sm leading-relaxed text-foreground/55">{error}</p>
          <Button asChild variant="secondary" className="mt-6">
            <Link to="/auth">Return to account access</Link>
          </Button>
        </section>
      </main>
    );
